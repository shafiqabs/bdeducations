...
class GroupController extends Controller
{
	...
	public function listAction()
	{
		...
		return $this->container->get('templating')->renderResponse('UserBundle:Group:list.html.'.$this->getEngine(), array('groups' => $groups));
	}
	...
	public function newAction(Request $request)
	{
		...
		return $this->container->get('templating')->renderResponse('UserBundle:Group:new.html.'.$this->getEngine(), array(
	...
	public function editByIdAction(Request $request, Group $group)
	{
		...
		return $this->container->get('templating')->renderResponse('UserBundle:Group:edit.html.'.$this->getEngine(), array(
			'form'      => $form->createview(),
			'group'  => $group,
		));
	}
	 ...
	 * @return TermManager
	 */
	protected function getTermManager()
	{
		return $this->get('docudex.document.term_manager');
	}
}