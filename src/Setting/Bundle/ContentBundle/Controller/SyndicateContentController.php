...
class SyndicateContentController extends Controller
{
    ...
    private function createCreateForm(SyndicateContent $entity)
    {
        ...
        $form = $this->createForm(new SyndicateContentType($user->getId(),$siteSettingId), $entity, array(
    ...
    */
    private function createEditForm(SyndicateContent $entity)
    {
       ...
       $siteSettingId = $this->get('security.context')->getToken()->getUser()->getSiteSetting()->getId();
            $form = $this->createForm(new SyndicateContentType($user,$siteSettingId), $entity, array(
