...
class SyndicateModuleType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('moduleClass','text', array('attr'=>array('class'=>'form-control input-sm','placeholder'=>'Enter module class name'),
                'constraints' =>array(
                    new NotBlank(array('message'=>'Please input required')),
                    new Length(array('max'=>200))
                )
            ...
            ->add('description','textarea', array('attr'=>array('class'=>'form-control','placeholder'=>'', 'row'=> 5) ))
